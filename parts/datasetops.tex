...
\noindent{\hspace*{\fill}\sphinxincludegraphics[height=.3\textheight]{{help_bw}.pdf}\hspace*{\fill}}
...
\vspace{2cm}
\noindent{\hspace*{\fill}\sphinxincludegraphics[width=\linewidth]{{dataset_ops_bw}.pdf}\hspace*{\fill}}
% beauty page break
\newpage
