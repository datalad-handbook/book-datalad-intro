...
book will show you the principles of DataLad, and from chapter {\hyperref[\detokenize{basics/101-101-create:createds}]{\sphinxcrossref{\DUrole{std,std-ref}{Create a dataset}}}} (\autopageref*{\detokenize{basics/101-101-create:createds}}) onward,
...
For example, ✂UUID✂ indicates that a long {\hyperref[\detokenize{glossary:UUID}]{\sphinxtermref{\DUrole{xref,std,std-term}{UUID}}}} identifier has been substituted completely.
In the example below, a commit {\hyperref[\detokenize{glossary:term-shasum}]{\sphinxtermref{\DUrole{xref,std,std-term}{shasum}}}} has been shortened and marked with \sphinxcode{\sphinxupquote{✂SHA1}}.
...
\sphinxAtStartPar
This book’s content roughly matches the \sphinxstyleemphasis{Basics} part of the online\sphinxhyphen{}handbook.
...
Basics.
And in the part, \sphinxstyleemphasis{Use cases}, you will find concrete examples of
...
\sphinxAtStartPar
If you are a Windows user with a native (i.e., not \dlhbhref{W1X}{Windows Subsystem for Linux (WSL)} based) DataLad installation, pay close attention to the special notes in so\sphinxhyphen{}called “Windows\sphinxhyphen{}Wits”:
...
If you are looking for a feature but cannot find it in this introduction, please take a look at the online-handbook, the DataLad \dlhbhref{D1}{documentation}, or the various extensions’ documentations.
