\chapter{Make the most out of datasets}
...
\index{YODA principles@\spxentry{YODA principles}|spxpagem}\ignorespaces 
...
“That’s because it’s a \dlhbhref{W1O}{recursive acronym},
...
\item {} 
\sphinxAtStartPar
Collect \sphinxstylestrong{results} of an analysis in a dedicated \sphinxcode{\sphinxupquote{outputs/}} directory, and
...
\PYG{g+go}{│       └── dataset2/}
\PYG{g+go}{│           └── datafile\PYGZus{}a}
\PYG{g+go}{├── outputs/                    \PYGZsh{} outputs away from the input data}
\PYG{g+go}{│   └── important\PYGZus{}results/}
\PYG{g+go}{│       └── figures/}
...
\sphinxAtStartPar
You can get a few non\sphinxhyphen{}DataLad related advice for structuring your directories in the {\hyperref[\detokenize{basics/101-127-yoda:fom-yodaproject}]{\sphinxcrossref{\DUrole{std,std-ref}{on best practices for analysis organization}}}} (\autopageref*{\detokenize{basics/101-127-yoda:fom-yodaproject}}).

\index{recommendation@\spxentry{recommendation}!dataset content organization@\spxentry{dataset content organization}}\index{dataset content organization@\spxentry{dataset content organization}!recommendation@\spxentry{recommendation}}\ignorespaces \begin{findoutmore}[label={fom-yodaproject}, before title={\thetcbcounter\ }, float, check odd page=true]{More best practices for organizing contents in directories}
...
The command \sphinxcode{\sphinxupquote{datalad containers\sphinxhyphen{}run}} (it will be introduced in
section {\hyperref[\detokenize{basics/101-133-containersrun:containersrun}]{\sphinxcrossref{\DUrole{std,std-ref}{Computational reproducibility with software containers}}}} (\autopageref*{\detokenize{basics/101-133-containersrun:containersrun}})) performs a command execution within
...
\begin{footnote}\sphinxAtStartFootnote
To re\sphinxhyphen{}read how \sphinxcode{\sphinxupquote{.gitattributes}} work, go back to section {\hyperref[\detokenize{basics/101-122-config:config}]{\sphinxcrossref{\DUrole{std,std-ref}{DIY configurations}}}} (\autopageref*{\detokenize{basics/101-122-config:config}}), and to remind yourself
...
a Python API for DataLad’s functionality that you can read about in {\hyperref[\detokenize{basics/101-130-yodaproject:fom-pythonapi}]{\sphinxcrossref{\DUrole{std,std-ref}{a Findoutmore on DataLad in Python}}}} (\autopageref*{\detokenize{basics/101-130-yodaproject:fom-pythonapi}}).
...
\index{reproducible paper@\spxentry{reproducible paper}!with DataLad@\spxentry{with DataLad}}\index{with DataLad@\spxentry{with DataLad}!reproducible paper@\spxentry{reproducible paper}}\ignorespaces \begin{importantnote}[label={index-2}, before title={\thetcbcounter\ }, check odd page=true]{Turn data analysis into dynamically generated documents}
...
independent dataset from scratch in a {\hyperref[\detokenize{basics/101-130-yodaproject:fom-iris}]{\sphinxcrossref{\DUrole{std,std-ref}{dedicated Findoutmore}}}} (\autopageref*{\detokenize{basics/101-130-yodaproject:fom-iris}}).

\index{create and publish dataset as dependency@\spxentry{create and publish dataset as dependency}!with DataLad@\spxentry{with DataLad}}\index{with DataLad@\spxentry{with DataLad}!create and publish dataset as dependency@\spxentry{create and publish dataset as dependency}}\ignorespaces \begin{findoutmore}[label={fom-iris}, before title={\thetcbcounter\ }, check odd page=true]{Creating an independent input dataset}
...
\begin{sphinxVerbatim}[commandchars=\\\{\}]
\PYG{g+gp}{\PYGZsh{} }make\PYG{+w}{ }sure\PYG{+w}{ }to\PYG{+w}{ }move\PYG{+w}{ }outside\PYG{+w}{ }of\PYG{+w}{ }DataLad\PYGZhy{}101!
...
\dlhbhref{G12A}{GitHub Gist}, a code snippet, or other short standalone information with a
...
\begin{sphinxVerbatim}[commandchars=\\\{\}]
\PYG{g+gp}{\PYGZsh{} }inside\PYG{+w}{ }of\PYG{+w}{ }DataLad\PYGZhy{}101
...
\begin{sphinxVerbatim}[commandchars=\\\{\}]
\PYG{g+gp}{\PYGZdl{} }\PYG{n+nb}{cd}\PYG{+w}{ }midterm\PYGZus{}project
\PYG{g+gp}{\PYGZsh{} }we\PYG{+w}{ }are\PYG{+w}{ }\PYG{k}{in}\PYG{+w}{ }midterm\PYGZus{}project,\PYG{+w}{ }thus\PYG{+w}{ }\PYGZhy{}d\PYG{+w}{ }.\PYG{+w}{ }points\PYG{+w}{ }to\PYG{+w}{ }the\PYG{+w}{ }root\PYG{+w}{ }of\PYG{+w}{ }it.
...
dataset, as is its \sphinxcode{\sphinxupquote{input/}} subdataset:
...
point with the \sphinxcode{\sphinxupquote{\sphinxhyphen{}\sphinxhyphen{}version\sphinxhyphen{}tag}} option of \sphinxcode{\sphinxupquote{datalad save}}.
...
\index{tag@\spxentry{tag}!Git concept@\spxentry{Git concept}}\index{Git concept@\spxentry{Git concept}!tag@\spxentry{tag}}\index{show@\spxentry{show}!Git command@\spxentry{Git command}}\index{Git command@\spxentry{Git command}!show@\spxentry{show}}\index{rerun command@\spxentry{rerun command}!with DataLad@\spxentry{with DataLad}}\index{with DataLad@\spxentry{with DataLad}!rerun command@\spxentry{rerun command}}\ignorespaces \begin{findoutmore}[label={index-6}, before title={\thetcbcounter\ }, check odd page=true]{What is a tag?}
...
\index{python instead of python3@\spxentry{python instead of python3}!on Windows@\spxentry{on Windows}}\index{on Windows@\spxentry{on Windows}!python instead of python3@\spxentry{python instead of python3}}\ignorespaces \begin{windowswit}[label={index-7}, before title={\thetcbcounter\ }, check odd page=true]{You may need to use ‘python’, not ‘python3’}
\label{\detokenize{basics/101-130-yodaproject:index-7}}

\sphinxAtStartPar
If executing the code below returns an exit code of 9009, there may be no \sphinxcode{\sphinxupquote{python3}} \textendash{} instead, it is called solely \sphinxcode{\sphinxupquote{python}}.
...
\def\sphinxLiteralBlockLabel{\label{\detokenize{basics/101-130-yodaproject:index-8}}}
\begin{sphinxVerbatim}[commandchars=\\\{\}]
...
configurations and run\sphinxhyphen{}procedures, start with section {\hyperref[\detokenize{basics/101-122-config:config}]{\sphinxcrossref{\DUrole{std,std-ref}{DIY configurations}}}} (\autopageref*{\detokenize{basics/101-122-config:config}}).
%
\end{footnote}.

\begin{sphinxVerbatim}[commandchars=\\\{\}]
\PYG{g+gp}{\PYGZsh{} }with\PYG{+w}{ }the\PYG{+w}{ }\PYGZgt{}\PYG{p}{|}\PYG{+w}{ }redirection\PYG{+w}{ }we\PYG{+w}{ }are\PYG{+w}{ }replacing\PYG{+w}{ }existing\PYG{+w}{ }contents\PYG{+w}{ }\PYG{k}{in}\PYG{+w}{ }the\PYG{+w}{ }file
...
syllabus, this should be done via {\hyperref[\detokenize{glossary:term-GitHub}]{\sphinxtermref{\DUrole{xref,std,std-term}{GitHub}}}}.

\index{dataset hosting@\spxentry{dataset hosting}!GitHub@\spxentry{GitHub}}\ignorespaces \begin{findoutmore}[label={index-10}, before title={\thetcbcounter\ }, check odd page=true]{What is GitHub?}
...
\noindent\sphinxincludegraphics{{screenshot_midtermproject}.png}
...
\noindent\sphinxincludegraphics{{screenshot_submodule}.png}
...
\index{GitHub token@\spxentry{GitHub token}!credential@\spxentry{credential}}\index{credential@\spxentry{credential}!GitHub token@\spxentry{GitHub token}}\ignorespaces \begin{importantnote}[label={index-13}, before title={\thetcbcounter\ }, check odd page=true]{Generate a GitHub token}
...
\index{credential@\spxentry{credential}!entry@\spxentry{entry}}\index{typed credentials are not displayed@\spxentry{typed credentials are not displayed}!on Windows@\spxentry{on Windows}}\index{on Windows@\spxentry{on Windows}!typed credentials are not displayed@\spxentry{typed credentials are not displayed}}\ignorespaces \begin{windowswit}[label={index-14}, before title={\thetcbcounter\ }, check odd page=true]{Your shell will not display credentials}
...
First, you will see a \sphinxcode{\sphinxupquote{datalad push}} to GitHub, and the {\hyperref[\detokenize{basics/101-130-yodaproject:fom-midtermclone}]{\sphinxcrossref{\DUrole{std,std-ref}{Findoutmore on the published dataset}}}} (\autopageref*{\detokenize{basics/101-130-yodaproject:fom-midtermclone}})
...
\index{push (tag)@\spxentry{push}\spxextra{tag}!with DataLad@\spxentry{with DataLad}}\index{with DataLad@\spxentry{with DataLad}!push (tag)@\spxentry{push}\spxextra{tag}}\ignorespaces \begin{gitusernote}[label={index-18}, before title={\thetcbcounter\ }, check odd page=true]{Pushing tags}
...
\label{\detokenize{basics/101-130-yodaproject:on-the-looks-and-feels-of-a-published-dataset}}\label{\detokenize{basics/101-130-yodaproject:index-19}}
\sphinxAtStartPar
...
\noindent\sphinxincludegraphics[width=0.500\linewidth]{{reproduced}.pdf}

\index{push@\spxentry{push}!DataLad concept@\spxentry{DataLad concept}}\index{DataLad concept@\spxentry{DataLad concept}!push@\spxentry{push}}\ignorespaces \begin{gitusernote}[label={index-20}, before title={\thetcbcounter\ }, check odd page=true]{Push internals}
\label{\detokenize{basics/101-130-yodaproject:index-20}}
