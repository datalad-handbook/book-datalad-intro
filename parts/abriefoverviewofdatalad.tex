...
\sphinxAtStartPar
To make it short, \dlhbhref{D4}{DataLad} is a software tool developed to aid with everything
...
{\hyperref[\detokenize{glossary:term-metadata}]{\sphinxtermref{\DUrole{xref,std,std-term}{metadata}}}} and {\hyperref[\detokenize{glossary:term-provenance}]{\sphinxtermref{\DUrole{xref,std,std-term}{provenance}}}} \textemdash{} and anything (or everything)
can be easily shared, \sphinxstyleemphasis{if} that is desired.
