...
\noindent{\hspace*{\fill}\sphinxincludegraphics[height=.3\textheight]{{collaboration_sketch_bw}.pdf}\hspace*{\fill}}
...
\index{sibling@\spxentry{sibling}!DataLad concept@\spxentry{DataLad concept}}\index{DataLad concept@\spxentry{DataLad concept}!sibling@\spxentry{sibling}}\ignorespaces \begin{gitusernote}[label={index-2}, before title={\thetcbcounter\ }, float, floatplacement=tbp, check odd page=true]{Remote siblings}
